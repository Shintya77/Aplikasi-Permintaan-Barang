...
class Scene extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        // detailpermintaanmenunonuserala (81:195)
        width: double.infinity,
        height: 800*fem,
        ...
        child: Container(
          ...
          child: Stack(
            children: [
              Positioned(
                ...
                child: Align(
                  child: SizedBox(
                    ...
                    height: 15*fem,
                    child: Image.asset(
                      'assets/page-1/images/group-17-aHP.png',
                      width: 8.68*fem,
                      height: 15*fem,
                    ),
                  ),
              ...
              Positioned(
                // gameiconswatergallonN5X (81:207)
                left: 144*fem,
                top: 151*fem,
                child: Align(
                  child: SizedBox(
                    ...
                    height: 71*fem,
                    child: Image.asset(
                      'assets/page-1/images/game-icons-water-gallon-Dus.png',
                      width: 71*fem,
                      height: 71*fem,
                    ),
                  ),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        // charmcircletickvuf (81:211)
                        margin: EdgeInsets.fromLTRB(1*fem, 0*fem, 0*fem, 25.84*fem),
                        width: 70.32*fem,
                        height: 70.24*fem,
                        child: Image.asset(
                          'assets/page-1/images/charm-circle-tick-Nz5.png',
                          width: 70.32*fem,
                          height: 70.24*fem,
                        ),
                      ),
                      Container(
                        // permintaanbarangandaberhasilte (81:215)
