...
class Scene extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        // menuusernonalattulisairmineral (81:60)
        ...
        child: Column(
          ...
          children: [
            Container(
              // autogroupdzvhva5 (ERf9MYaPmWjSmvigeSdzvH)
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 15*fem,
                    child: Image.asset(
                      'assets/page-1/images/group-17-oQV.png',
                      width: 8.68*fem,
                      height: 15*fem,
                    ),
                  ),
                  Text(
                    // detailpermintaanNS5 (81:74)
                    'Detail Permintaan',
            ...
            Container(
              // autogroupjwkjgSm (ERf9TNk1ddoEJptXGXjwKj)
              margin: EdgeInsets.fromLTRB(61*fem, 0*fem, 63*fem, 35*fem),
              padding: EdgeInsets.fromLTRB(44*fem, 46*fem, 49*fem, 47*fem),
              width: double.infinity,
              height: 164*fem,
              decoration: BoxDecoration (
              ...
              child: Container(
                ...
                decoration: BoxDecoration (
                  image: DecorationImage (
                    fit: BoxFit.cover,
                    image: AssetImage (
                      'assets/page-1/images/vector-XG5.png',
                    ),
                  ),
                ),
                child: Center(
                  ...
                  child: SizedBox(
                    ...
                    height: 59.17*fem,
                    child: Image.asset(
                      'assets/page-1/images/vector-cWD.png',
                      width: 46.64*fem,
                      height: 59.17*fem,
                    ),
                  ),
            ...
            Container(
              // autogroupaghkp57 (ERf9YxR3eP1y4VDt7zAgHK)
            ...
            Container(
              // autogroupwp8dxKj (ERf9f35FMsvoNdECWhwp8d)
              ...
              child: Stack(
                children: [
                  Positioned(
                    ...
                    top: 0*fem,
                    child: Container(
                      padding: EdgeInsets.fromLTRB(145*fem, 38*fem, 42*fem, 138*fem),
                      width: 287*fem,
                      height: 205*fem,
                      decoration: BoxDecoration (
