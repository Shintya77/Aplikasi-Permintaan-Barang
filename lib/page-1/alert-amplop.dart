              ...
              Positioned(
                ...
                child: Align(
                  child: SizedBox(
                    ...
                    height: 15*fem,
                    child: Image.asset(
                      'assets/page-1/images/group-17-zTs.png',
                      width: 8.68*fem,
                      height: 15*fem,
                    ),
                  ),
              ...
              Positioned(
                ...
                child: Align(
                  child: SizedBox(
                    ...
                    height: 50*fem,
                    child: Image.asset(
                      'assets/page-1/images/ph-envelope.png',
                      width: 65*fem,
                      height: 50*fem,
                    ),
                  ),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        // charmcircletickStH (46:181)
                        margin: EdgeInsets.fromLTRB(1*fem, 0*fem, 0*fem, 25.84*fem),
                        width: 70.32*fem,
                        height: 70.24*fem,
                        child: Image.asset(
                          'assets/page-1/images/charm-circle-tick-iU9.png',
                          width: 70.32*fem,
                          height: 70.24*fem,
                        ),
                      ),
                      Container(
                        // permintaanbarangandaberhasilte (46:185)
