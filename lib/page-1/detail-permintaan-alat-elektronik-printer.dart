...
class Scene extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        // detailpermintaanalatelektronik (81:625)
        width: double.infinity,
        height: 800*fem,
              ...
              Positioned(
                ...
                child: Align(
                  child: SizedBox(
                    ...
                    height: 15*fem,
                    child: Image.asset(
                      'assets/page-1/images/group-17-rCZ.png',
                      width: 8.68*fem,
                      height: 15*fem,
                    ),
                  ),
              ...
              Positioned(
                ...
                child: Align(
                  child: SizedBox(
                    ...
                    height: 71*fem,
                    child: Image.asset(
                      'assets/page-1/images/image-10-7Ld.png',
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        // charmcircletickBxm (81:641)
                        margin: EdgeInsets.fromLTRB(1*fem, 0*fem, 0*fem, 25.84*fem),
                        width: 70.32*fem,
                        height: 70.24*fem,
                        child: Image.asset(
                          'assets/page-1/images/charm-circle-tick-Ee5.png',
                          width: 70.32*fem,
                          height: 70.24*fem,
                        ),
                      ),
                      Container(
                        // permintaanbarangandaberhasilte (81:645)
