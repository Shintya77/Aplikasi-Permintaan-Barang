...
class Scene extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        // menuusernonalattulislainnya9gu (81:108)
        ...
        child: Column(
          ...
          children: [
            Container(
              // autogroupfiymFE9 (ERfB7Kz8YGXdpRrNmMFiYm)
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 15*fem,
                    child: Image.asset(
                      'assets/page-1/images/group-17-hmT.png',
                      width: 8.68*fem,
                      height: 15*fem,
                    ),
                  ),
                  Text(
                    // detailpermintaan6Em (81:119)
                    'Detail Permintaan',
            ...
            Container(
              // autogroupgszzELy (ERfBDjy7PbuCWDdzrFGSzZ)
              ...
              child: Center(
                ...
                child: SizedBox(
                  ...
                  height: 47.33*fem,
                  child: Image.asset(
                    'assets/page-1/images/typcn-plus-6Rw.png',
                    width: 47.33*fem,
                    height: 47.33*fem,
                  ),
                ),
            ...
            Container(
              // autogroupkciqDih (ERfBJ5BE9TthMgnxrYKCiq)
            ...
            Container(
              // autogroupejimnQR (ERfBQEfd9RRDGEk7Aoejim)
