        ...
        child: Container(
          ...
          child: Stack(
            children: [
              Positioned(
                ...
                child: Align(
                  child: SizedBox(
                    ...
                    height: 15*fem,
                    child: Image.asset(
                      'assets/page-1/images/group-17-5kM.png',
                      width: 8.68*fem,
                      height: 15*fem,
                    ),
                  ),
              ...
              Positioned(
                // raphaelclip9Ah (46:271)
                left: 159.1691894531*fem,
                ...
                child: Align(
                  child: SizedBox(
                    ...
                    height: 52.33*fem,
                    child: Image.asset(
                      'assets/page-1/images/raphael-clip-WZo.png',
                      width: 46.23*fem,
                      height: 52.33*fem,
                    ),
                  ),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        // charmcircletickiWd (46:259)
                        margin: EdgeInsets.fromLTRB(1*fem, 0*fem, 0*fem, 25.84*fem),
                        width: 70.32*fem,
                        height: 70.24*fem,
                        child: Image.asset(
                          'assets/page-1/images/charm-circle-tick-F1T.png',
                          width: 70.32*fem,
                          height: 70.24*fem,
                        ),
                      ),
                      Container(
                        // permintaanbarangandaberhasilte (46:263)
