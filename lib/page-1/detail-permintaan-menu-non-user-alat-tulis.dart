...
class Scene extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        // detailpermintaanmenunonuserala (81:163)
        width: double.infinity,
        height: 800*fem,
        ...
        child: Container(
          ...
          child: Stack(
            children: [
              Positioned(
                ...
                child: Align(
                  child: SizedBox(
                    ...
                    height: 15*fem,
                    child: Image.asset(
                      'assets/page-1/images/group-17-RgV.png',
                      width: 8.68*fem,
                      height: 15*fem,
                    ),
                  ),
              ...
              Positioned(
                // gameiconswatergallonDUu (81:185)
                left: 160.779296875*fem,
                top: 154.466796875*fem,
                child: Align(
                  child: SizedBox(
                    width: 37.44*fem,
                    height: 64.07*fem,
                    child: Image.asset(
                      'assets/page-1/images/game-icons-water-gallon-iGZ.png',
                      width: 37.44*fem,
                      height: 64.07*fem,
                    ),
                  ),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        // charmcircletickCVF (81:179)
                        margin: EdgeInsets.fromLTRB(1*fem, 0*fem, 0*fem, 25.84*fem),
                        width: 70.32*fem,
                        height: 70.24*fem,
                        child: Image.asset(
                          'assets/page-1/images/charm-circle-tick-hFF.png',
                          width: 70.32*fem,
                          height: 70.24*fem,
                        ),
                      ),
                      Container(
                        // permintaanbarangandaberhasilte (81:183)
