        ...
        child: Container(
          ...
          child: Stack(
            children: [
              Positioned(
                ...
                child: Align(
                  child: SizedBox(
                    ...
                    height: 15*fem,
                    child: Image.asset(
                      'assets/page-1/images/group-17-AqX.png',
                      width: 8.68*fem,
                      height: 15*fem,
                    ),
                  ),
              ...
              Positioned(
                // gameiconsrolledclothyey (56:427)
                left: 144.0625*fem,
                top: 152.4364013672*fem,
                child: Align(
                  child: SizedBox(
                    width: 71.88*fem,
                    height: 69.13*fem,
                    child: Image.asset(
                      'assets/page-1/images/game-icons-rolled-cloth-4hF.png',
                      width: 71.88*fem,
                      height: 69.13*fem,
                    ),
                  ),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        // charmcircletick5V3 (56:417)
                        margin: EdgeInsets.fromLTRB(1*fem, 0*fem, 0*fem, 25.84*fem),
                        width: 70.32*fem,
                        height: 70.24*fem,
                        child: Image.asset(
                          'assets/page-1/images/charm-circle-tick-hQM.png',
                          width: 70.32*fem,
                          height: 70.24*fem,
                        ),
                      ),
                      Container(
                        // permintaanbarangandaberhasilte (56:421)
