    ...
    return Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              // autogroup1akdRww (ERfP2QJJ1czXdqqsLs1Akd)
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 15*fem,
                    child: Image.asset(
                      'assets/page-1/images/group-17-Fr1.png',
                      width: 8.68*fem,
                      height: 15*fem,
                    ),
                  ),
                  Text(
                    // detailpermintaan4ED (46:312)
                    'Detail Permintaan',
            ...
            Container(
              // autogrouplhkzz7s (ERfP8Znh1aX3YPo1f8LhkZ)
              margin: EdgeInsets.fromLTRB(61*fem, 0*fem, 63*fem, 35*fem),
              padding: EdgeInsets.fromLTRB(54*fem, 47*fem, 50*fem, 49.5*fem),
              width: double.infinity,
              decoration: BoxDecoration (
              ...
              child: Center(
                ...
                child: SizedBox(
                  ...
                  height: 67.5*fem,
                  child: Image.asset(
                    'assets/page-1/images/ph-stamp.png',
                    width: 60*fem,
                    height: 67.5*fem,
                  ),
                ),
            ...
            Container(
              // autogroupwfn5zGH (ERfPD4fCLMjuagqdWWWFn5)
            ...
            Container(
              // autogroupabl9Zyb (ERfPJyf1UwRNhzxJ49AbL9)
